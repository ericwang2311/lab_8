...
//To help to position labels without overlap, call the following function for each text element:
function position(d) {
...
// Call the following `halo` function which generates a white glow for each text element
function halo(text) {
  text
    .select(function () {
